...
void AdvancedOptionsWindow::changecoloursandshades()
{
   ...
   if(prof->is_realized())
      prof->coloursandshades(heightmaxselect->get_value(), heightminselect->get_value(), intensitymaxselect->get_value_as_int(),
   ...
   if(tdo->is_realized())
      tdo->coloursandshades(heightmaxselect->get_value(), heightminselect->get_value(), intensitymaxselect->get_value_as_int(),
                            intensityminselect->get_value_as_int());
